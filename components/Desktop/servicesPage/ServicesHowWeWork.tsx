...
export const ServicesHowWeWork = () => {
    ...
    return (
        <div className='md:w-[90%] xl:w-[75%] 2xl:w-[50%] mx-auto my-28'>
            <h1 className='md:text-2xl lg:text-3xl text-gray-600 font-bold'>How We Work</h1>
                ...
                <div>
                    <div className='flex justify-between'>
                        <h2
                            className={`${
                                !showFirstText
                                    ? 'text-gray-300 md:text-xl lg:text-2xl my-4'
                                    : 'text-gray-500 md:text-xl lg:text-2xl my-4'
                            } `}
