...
import {
    weddingJoseDanielHome,
    weddingJoseDanielPaquetes,
    weddingJoseDanielPortfolio,
} from '@/constants';

export const WeddingJoseDanielMobile = () => {
            ...
            <div data-aos={fadeIn}>
                <div className='w-[80%] mx-auto mb-28'>
                    <div className='flex justify-center my-12'>
                        ...
                        <p className='text-gray-600 text-[18px] tracking-widest'>
                            WEDDING JOSE DANIEL
                        </p>
                    </div>
                    <div className='my-6'>
                        <div className='mt-6 mb-10'>
                            ...
                            <h3 className='text-gray-500 text-[16px]'>June 2023</h3>
                        </div>
                        <div className='my-10'>
                    ...
                    <div className='rounded-xl my-20'>
                        ...
                        <div className='mb-20 shadow-xl'>
                            {weddingJoseDanielPortfolio.map((el) => (
                                <Image
                                    key={el.id}
                                    className='w-full object-cover rounded-xl mt-4'
                                    src={el.img.src}
                        ...
                        <div className='mb-20 shadow-xl'>
                            {weddingJoseDanielPaquetes.map((el) => (
                                <Image
                                    key={el.id}
                                    className='w-full object-cover rounded-xl mt-4'
                                    src={el.img.src}
