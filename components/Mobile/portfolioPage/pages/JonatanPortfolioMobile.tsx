...
import { jonatanPortfolioHome } from '@/constants';

export const JonatanPortfolioMobile = () => {
            ...
            <div data-aos={fadeIn}>
                <div className='w-[80%] mx-auto mb-28'>
                    <div className='flex justify-center my-12'>
                        ...
                        <p className='text-gray-600 text-[18px] tracking-widest'>JONATAN RAMIREZ</p>
                    </div>
                    <div className='my-6'>
                        <div className='mt-6 mb-10'>
                            <h2 className='my-2 text-gray-700 font-bold text-[16px]'>DATE:</h2>
                            <h3 className='text-gray-500 text-[16px]'>April 2023</h3>
                        </div>
                        <div className='my-10'>
