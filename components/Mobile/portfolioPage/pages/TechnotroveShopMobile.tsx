...
import { technoTroveHome, technoTroveKid, technoTroveWoman } from '@/constants';

export const TechnotroveShopMobile = () => {
                ...
                <div className='w-[80%] mx-auto mb-28'>
                    ...
                    <div className='my-6'>
                        <div className='mt-6 mb-10'>
                            ...
                            <h3 className='text-gray-500 text-[16px]'>September 2023</h3>
                        </div>
                        <div className='my-10'>
